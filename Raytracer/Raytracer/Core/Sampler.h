...
/**
* The class is responsible for generating samples. Sub-samplers generates samples for the specified sub-region of the image space. Sub-samplers are generated by Sampler class.
