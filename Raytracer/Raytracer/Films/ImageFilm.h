...
/**
* Implementation of the Film that stores the resulting image as a two-dimensional array.
...
class ImageFilm: public Film
  ...
  private:
    ...
    std::vector< std::vector<ImageFilmPixel> > m_pixels; // TBD: rewrite as blocked array
