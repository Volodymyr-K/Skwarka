...
CxxTest::StaticSuiteDescription suiteDescription_LightSourcesTestSuite( "./LightSources.test.h", 11, "LightSourcesTestSuite", suite_LightSourcesTestSuite, Tests_LightSourcesTestSuite );

static class TestDescription_LightSourcesTestSuite_test_AreaLightSource_Radiance : public CxxTest::RealTestDescription {
public:
 TestDescription_LightSourcesTestSuite_test_AreaLightSource_Radiance() : CxxTest::RealTestDescription( Tests_LightSourcesTestSuite, suiteDescription_LightSourcesTestSuite, 41, "test_AreaLightSource_Radiance" ) {}
...
public:
 TestDescription_LightSourcesTestSuite_test_AreaLightSource_Power() : CxxTest::RealTestDescription( Tests_LightSourcesTestSuite, suiteDescription_LightSourcesTestSuite, 47, "test_AreaLightSource_Power" ) {}
...
public:
 TestDescription_LightSourcesTestSuite_test_AreaLightSource_SampleLighting() : CxxTest::RealTestDescription( Tests_LightSourcesTestSuite, suiteDescription_LightSourcesTestSuite, 57, "test_AreaLightSource_SampleLighting" ) {}
...
public:
 TestDescription_LightSourcesTestSuite_test_AreaLightSource_LightingPDF() : CxxTest::RealTestDescription( Tests_LightSourcesTestSuite, suiteDescription_LightSourcesTestSuite, 95, "test_AreaLightSource_LightingPDF" ) {}
...
public:
 TestDescription_LightSourcesTestSuite_test_AreaLightSource_LightingPDFSum() : CxxTest::RealTestDescription( Tests_LightSourcesTestSuite, suiteDescription_LightSourcesTestSuite, 121, "test_AreaLightSource_LightingPDFSum" ) {}
...
public:
 TestDescription_LightSourcesTestSuite_test_AreaLightSource_SamplePhoton() : CxxTest::RealTestDescription( Tests_LightSourcesTestSuite, suiteDescription_LightSourcesTestSuite, 150, "test_AreaLightSource_SamplePhoton" ) {}
