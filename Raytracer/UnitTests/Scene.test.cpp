...
CxxTest::StaticSuiteDescription suiteDescription_SceneTestSuite( "./Scene.test.h", 16, "SceneTestSuite", suite_SceneTestSuite, Tests_SceneTestSuite );

static class TestDescription_SceneTestSuite_test_Scene_GetPrimitives : public CxxTest::RealTestDescription {
public:
 TestDescription_SceneTestSuite_test_Scene_GetPrimitives() : CxxTest::RealTestDescription( Tests_SceneTestSuite, suiteDescription_SceneTestSuite, 44, "test_Scene_GetPrimitives" ) {}
...
public:
 TestDescription_SceneTestSuite_test_Scene_GetWorldBounds() : CxxTest::RealTestDescription( Tests_SceneTestSuite, suiteDescription_SceneTestSuite, 49, "test_Scene_GetWorldBounds" ) {}
...
public:
 TestDescription_SceneTestSuite_test_Scene_Intersect() : CxxTest::RealTestDescription( Tests_SceneTestSuite, suiteDescription_SceneTestSuite, 59, "test_Scene_Intersect" ) {}
...
public:
 TestDescription_SceneTestSuite_test_Scene_IntersectTest1() : CxxTest::RealTestDescription( Tests_SceneTestSuite, suiteDescription_SceneTestSuite, 74, "test_Scene_IntersectTest1" ) {}
...
public:
 TestDescription_SceneTestSuite_test_Scene_IntersectTest2() : CxxTest::RealTestDescription( Tests_SceneTestSuite, suiteDescription_SceneTestSuite, 82, "test_Scene_IntersectTest2" ) {}
