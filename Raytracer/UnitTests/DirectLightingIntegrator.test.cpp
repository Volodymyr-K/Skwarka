...
CxxTest::StaticSuiteDescription suiteDescription_DirectLightingIntegratorTestSuite( "./DirectLightingIntegrator.test.h", 17, "DirectLightingIntegratorTestSuite", suite_DirectLightingIntegratorTestSuite, Tests_DirectLightingIntegratorTestSuite );
...
public:
 TestDescription_DirectLightingIntegratorTestSuite_test_DirectLightingIntegrator_PointLight() : CxxTest::RealTestDescription( Tests_DirectLightingIntegratorTestSuite, suiteDescription_DirectLightingIntegratorTestSuite, 30, "test_DirectLightingIntegrator_PointLight" ) {}
...
public:
 TestDescription_DirectLightingIntegratorTestSuite_test_DirectLightingIntegrator_AreaLights() : CxxTest::RealTestDescription( Tests_DirectLightingIntegratorTestSuite, suiteDescription_DirectLightingIntegratorTestSuite, 92, "test_DirectLightingIntegrator_AreaLights" ) {}
...
public:
 TestDescription_DirectLightingIntegratorTestSuite_test_DirectLightingIntegrator_InfinityAndAreaLights() : CxxTest::RealTestDescription( Tests_DirectLightingIntegratorTestSuite, suiteDescription_DirectLightingIntegratorTestSuite, 128, "test_DirectLightingIntegrator_InfinityAndAreaLights" ) {}
...
public:
 TestDescription_DirectLightingIntegratorTestSuite_test_DirectLightingIntegrator_NoLighting() : CxxTest::RealTestDescription( Tests_DirectLightingIntegratorTestSuite, suiteDescription_DirectLightingIntegratorTestSuite, 165, "test_DirectLightingIntegrator_NoLighting" ) {}
