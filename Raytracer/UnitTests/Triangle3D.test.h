...
class Triangle3DTestSuite : public CxxTest::TestSuite
  ...
  public:
    ...
    void testTriangleDefaultConstr(void)
      {
      Triangle3D_d t;
    ...
    void testTriangleConstrWithVertices(void)
      {
    ...
    void testTriangleNormalOrientation(void)
      {
    ...
    void testTriangleIndexOperator(void)
      {
      Triangle3D_d t(m_vertices[0], m_vertices[1], m_vertices[2]);
