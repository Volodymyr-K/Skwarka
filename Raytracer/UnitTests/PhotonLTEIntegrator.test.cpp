...
public:
 TestDescription_PhotonLTEIntegratorTestSuite_test_PhotonLTEIntegrator_SelfIlluminatedSphere() : CxxTest::RealTestDescription( Tests_PhotonLTEIntegratorTestSuite, suiteDescription_PhotonLTEIntegratorTestSuite, 30, "test_PhotonLTEIntegrator_SelfIlluminatedSphere" ) {}
...
public:
 TestDescription_PhotonLTEIntegratorTestSuite_test_PhotonLTEIntegrator_PointLightInSphere() : CxxTest::RealTestDescription( Tests_PhotonLTEIntegratorTestSuite, suiteDescription_PhotonLTEIntegratorTestSuite, 72, "test_PhotonLTEIntegrator_PointLightInSphere" ) {}
