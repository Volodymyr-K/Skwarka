...
CxxTest::StaticSuiteDescription suiteDescription_StratifiedSamplerTestSuite( "./StratifiedSampler.test.h", 12, "StratifiedSamplerTestSuite", suite_StratifiedSamplerTestSuite, Tests_StratifiedSamplerTestSuite );

static class TestDescription_StratifiedSamplerTestSuite_test_StratifiedSampler_Constr : public CxxTest::RealTestDescription {
public:
 TestDescription_StratifiedSamplerTestSuite_test_StratifiedSampler_Constr() : CxxTest::RealTestDescription( Tests_StratifiedSamplerTestSuite, suiteDescription_StratifiedSamplerTestSuite, 15, "test_StratifiedSampler_Constr" ) {}
...
public:
 TestDescription_StratifiedSamplerTestSuite_test_StratifiedSampler_ImagePoints() : CxxTest::RealTestDescription( Tests_StratifiedSamplerTestSuite, suiteDescription_StratifiedSamplerTestSuite, 21, "test_StratifiedSampler_ImagePoints" ) {}
...
public:
 TestDescription_StratifiedSamplerTestSuite_test_StratifiedSampler_LensUVs() : CxxTest::RealTestDescription( Tests_StratifiedSamplerTestSuite, suiteDescription_StratifiedSamplerTestSuite, 46, "test_StratifiedSampler_LensUVs" ) {}
...
public:
 TestDescription_StratifiedSamplerTestSuite_test_StratifiedSampler_1DSequences() : CxxTest::RealTestDescription( Tests_StratifiedSamplerTestSuite, suiteDescription_StratifiedSamplerTestSuite, 80, "test_StratifiedSampler_1DSequences" ) {}
...
public:
 TestDescription_StratifiedSamplerTestSuite_test_StratifiedSampler_2DSequences() : CxxTest::RealTestDescription( Tests_StratifiedSamplerTestSuite, suiteDescription_StratifiedSamplerTestSuite, 116, "test_StratifiedSampler_2DSequences" ) {}
