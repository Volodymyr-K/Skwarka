...
static BxDFTestSuite suite_BxDFTestSuite;

static CxxTest::List Tests_BxDFTestSuite = { 0, 0 };
CxxTest::StaticSuiteDescription suiteDescription_BxDFTestSuite( "./BxDF.test.h", 14, "BxDFTestSuite", suite_BxDFTestSuite, Tests_BxDFTestSuite );

static class TestDescription_BxDFTestSuite_test_BxDF_Constr : public CxxTest::RealTestDescription {
public:
 TestDescription_BxDFTestSuite_test_BxDF_Constr() : CxxTest::RealTestDescription( Tests_BxDFTestSuite, suiteDescription_BxDFTestSuite, 17, "test_BxDF_Constr" ) {}
 void runTest() { suite_BxDFTestSuite.test_BxDF_Constr(); }
} testDescription_BxDFTestSuite_test_BxDF_Constr;

static class TestDescription_BxDFTestSuite_test_BxDF_MathcesFlags : public CxxTest::RealTestDescription {
public:
 TestDescription_BxDFTestSuite_test_BxDF_MathcesFlags() : CxxTest::RealTestDescription( Tests_BxDFTestSuite, suiteDescription_BxDFTestSuite, 24, "test_BxDF_MathcesFlags" ) {}
