...
CxxTest::StaticSuiteDescription suiteDescription_RandomSamplerTestSuite( "./RandomSampler.test.h", 12, "RandomSamplerTestSuite", suite_RandomSamplerTestSuite, Tests_RandomSamplerTestSuite );

static class TestDescription_RandomSamplerTestSuite_test_RandomSampler_Constr : public CxxTest::RealTestDescription {
public:
 TestDescription_RandomSamplerTestSuite_test_RandomSampler_Constr() : CxxTest::RealTestDescription( Tests_RandomSamplerTestSuite, suiteDescription_RandomSamplerTestSuite, 15, "test_RandomSampler_Constr" ) {}
...
public:
 TestDescription_RandomSamplerTestSuite_test_RandomSampler_ImagePoints() : CxxTest::RealTestDescription( Tests_RandomSamplerTestSuite, suiteDescription_RandomSamplerTestSuite, 21, "test_RandomSampler_ImagePoints" ) {}
...
public:
 TestDescription_RandomSamplerTestSuite_test_RandomSampler_LensUVs() : CxxTest::RealTestDescription( Tests_RandomSamplerTestSuite, suiteDescription_RandomSamplerTestSuite, 44, "test_RandomSampler_LensUVs" ) {}
...
public:
 TestDescription_RandomSamplerTestSuite_test_RandomSampler_1DSequences() : CxxTest::RealTestDescription( Tests_RandomSamplerTestSuite, suiteDescription_RandomSamplerTestSuite, 75, "test_RandomSampler_1DSequences" ) {}
...
public:
 TestDescription_RandomSamplerTestSuite_test_RandomSampler_2DSequences() : CxxTest::RealTestDescription( Tests_RandomSamplerTestSuite, suiteDescription_RandomSamplerTestSuite, 110, "test_RandomSampler_2DSequences" ) {}
