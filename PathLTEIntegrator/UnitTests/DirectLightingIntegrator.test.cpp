...
public:
 TestDescription_DirectLightingIntegratorTestSuite_test_DirectLightingIntegrator_PointLight() : CxxTest::RealTestDescription( Tests_DirectLightingIntegratorTestSuite, suiteDescription_DirectLightingIntegratorTestSuite, 29, "test_DirectLightingIntegrator_PointLight" ) {}
...
public:
 TestDescription_DirectLightingIntegratorTestSuite_test_DirectLightingIntegrator_InfinityLights() : CxxTest::RealTestDescription( Tests_DirectLightingIntegratorTestSuite, suiteDescription_DirectLightingIntegratorTestSuite, 58, "test_DirectLightingIntegrator_InfinityLights" ) {}
...
public:
 TestDescription_DirectLightingIntegratorTestSuite_test_DirectLightingIntegrator_AreaLights() : CxxTest::RealTestDescription( Tests_DirectLightingIntegratorTestSuite, suiteDescription_DirectLightingIntegratorTestSuite, 89, "test_DirectLightingIntegrator_AreaLights" ) {}
...
public:
 TestDescription_DirectLightingIntegratorTestSuite_test_DirectLightingIntegrator_NoLighting() : CxxTest::RealTestDescription( Tests_DirectLightingIntegratorTestSuite, suiteDescription_DirectLightingIntegratorTestSuite, 160, "test_DirectLightingIntegrator_NoLighting" ) {}
