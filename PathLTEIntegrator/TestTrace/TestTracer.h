...
inline void TestTracer::RenderImage()
  ...
  intrusive_ptr<Sampler> p_sampler( new LDSampler(window_begin, window_end, 128*64, pixel_order) );
  ...
  intrusive_ptr<LTEIntegrator> p_lte_int( new PathLTEIntegrator(mp_scene, NULL, p_direct_int, 18) );
