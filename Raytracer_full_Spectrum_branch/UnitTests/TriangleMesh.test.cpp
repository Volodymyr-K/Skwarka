...
CxxTest::StaticSuiteDescription suiteDescription_TriangleMeshTestSuite( "./TriangleMesh.test.h", 11, "TriangleMeshTestSuite", suite_TriangleMeshTestSuite, Tests_TriangleMeshTestSuite );

static class TestDescription_TriangleMeshTestSuite_test_TriangleMesh_Constr : public CxxTest::RealTestDescription {
public:
 TestDescription_TriangleMeshTestSuite_test_TriangleMesh_Constr() : CxxTest::RealTestDescription( Tests_TriangleMeshTestSuite, suiteDescription_TriangleMeshTestSuite, 14, "test_TriangleMesh_Constr" ) {}
...
public:
 TestDescription_TriangleMeshTestSuite_test_TriangleMesh_EmptyMesh() : CxxTest::RealTestDescription( Tests_TriangleMeshTestSuite, suiteDescription_TriangleMeshTestSuite, 22, "test_TriangleMesh_EmptyMesh" ) {}
...
static class TestDescription_TriangleMeshTestSuite_test_TriangleMesh_GetBounds : public CxxTest::RealTestDescription {
public:
 TestDescription_TriangleMeshTestSuite_test_TriangleMesh_GetBounds() : CxxTest::RealTestDescription( Tests_TriangleMeshTestSuite, suiteDescription_TriangleMeshTestSuite, 35, "test_TriangleMesh_GetBounds" ) {}
