#ifndef RANDOM_BLOCKED_IMAGE_PIXELS_ORDER_TEST_H
#define RANDOM_BLOCKED_IMAGE_PIXELS_ORDER_TEST_H
...
class RandomBlockedImagePixelsOrderTestSuite: public CxxTest::TestSuite
  {
  public:

    void test_RandomBlockedImagePixelsOrder_Constr()
      {
      RandomBlockedImagePixelsOrder pixels_order;
      pixels_order.SetImageSize(Point2D_i(0,0),Point2D_i(100,100));

      TS_ASSERT_EQUALS(pixels_order.GetTotalPixelsNum(), 100*100);
      }

    void test_RandomBlockedImagePixelsOrder_PixelsCount()
      {
      RandomBlockedImagePixelsOrder pixels_order;
    ...
    void test_RandomBlockedImagePixelsOrder_Reset()
      {
      RandomBlockedImagePixelsOrder pixels_order;
      pixels_order.SetImageSize(Point2D_i(0,0),Point2D_i(50,100));
...
#endif // RANDOM_BLOCKED_IMAGE_PIXELS_ORDER_TEST_H
