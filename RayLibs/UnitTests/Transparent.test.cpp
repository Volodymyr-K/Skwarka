...
public:
 TestDescription_TransparentTestSuite_test_Transparent_Components() : CxxTest::RealTestDescription( Tests_TransparentTestSuite, suiteDescription_TransparentTestSuite, 36, "test_Transparent_Components" ) {}
...
public:
 TestDescription_TransparentTestSuite_test_Transparent_RefractiveIndex() : CxxTest::RealTestDescription( Tests_TransparentTestSuite, suiteDescription_TransparentTestSuite, 49, "test_Transparent_RefractiveIndex" ) {}
...
public:
 TestDescription_TransparentTestSuite_test_Transparent_SpecularReflection() : CxxTest::RealTestDescription( Tests_TransparentTestSuite, suiteDescription_TransparentTestSuite, 59, "test_Transparent_SpecularReflection" ) {}
...
public:
 TestDescription_TransparentTestSuite_test_Transparent_SpecularTransmittance() : CxxTest::RealTestDescription( Tests_TransparentTestSuite, suiteDescription_TransparentTestSuite, 80, "test_Transparent_SpecularTransmittance" ) {}
