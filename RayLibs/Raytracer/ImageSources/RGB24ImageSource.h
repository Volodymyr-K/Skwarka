...
BOOST_CLASS_EXPORT_KEY(RGB24ImageSource_float)
BOOST_CLASS_EXPORT_KEY(RGB24ImageSource_double)
BOOST_CLASS_EXPORT_KEY(RGB24ImageSource_Spectrum_float)
BOOST_CLASS_EXPORT_KEY(RGB24ImageSource_Spectrum_double)
BOOST_CLASS_EXPORT_KEY(RGB24ImageSource_SpectrumCoef_float)
BOOST_CLASS_EXPORT_KEY(RGB24ImageSource_SpectrumCoef_double)
